...
> **Архів:** фаза 32 закрита. Фази 33–34 також closed — [pingui-correctness.md](pingui-correctness.md), [pingui-route-persistence.md](pingui-route-persistence.md). Актуальний ROADMAP **NEXT=P36-001** — [pingui-geoip.md](pingui-geoip.md).
