...
> **Архів:** фаза 32 закрита. Фаза 33 — [pingui-correctness.md](pingui-correctness.md) (архів). Актуальна фаза 34 — [pingui-route-persistence.md](pingui-route-persistence.md).
