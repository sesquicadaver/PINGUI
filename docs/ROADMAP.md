...
| Поле | Значення |
|------|----------|
| **Поточна задача** | **P20-006** |
| **Фаза** | 20 — GUI UX |
| **DoD (коротко)** | Keyboard accelerators (Save/Add/Help) |
| **Гілка** | `beta` |
...
**Стан черги:** відкрита — **NEXT = P20-006** (фаза 20 — GUI UX: швидкий UX → polish → feature depth).
...
**Backlog (історичний sprint-рядок):** M/B roadmap закрито; **IPv6 — Фаза 9**; **Python NOC — Фаза PY**; **Pro — Фази 10–19**; **Фаза 20 GUI UX**. Лінійна черга — **NEXT=P20-006**.
