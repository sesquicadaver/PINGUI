...
| Поле | Значення |
|------|----------|
| **Поточна задача** | **P22-003** |
| **Фаза** | 22 — Host problem UX |
| **DoD (коротко)** | SQLite: persist quality incidents |
| **Гілка** | `beta` |
...
**Стан черги:** відкрита — **NEXT = P22-003** (фаза 22 — host problem UX).
...
**Backlog (історичний sprint-рядок):** M/B roadmap закрито; **IPv6 — Фаза 9**; **Python NOC — Фаза PY**; **Pro — Фази 10–19**; **Фаза 20 GUI UX**. Лінійна черга — **NEXT=P22-003**.
