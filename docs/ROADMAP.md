...
| Поле | Значення |
|------|----------|
| **Поточна задача** | **P19-003** |
| **Фаза** | 19 — Production hardening |
| **DoD (коротко)** | Trace parser/builder unit tests + JaCoCo include |
| **Гілка** | `beta` |
...
**Стан черги:** відкрита — **NEXT = P19-003** (фаза 19, post-`main` hardening після аналізу 2026-07).
...
**Backlog (історичний sprint-рядок):** M/B roadmap закрито; **IPv6 — Фаза 9**; **Python NOC — Фаза PY**; **Pro — Фази 10–18 (P10–P18)**. Лінійна черга — **NEXT=P19-003** (фаза 19).
