...
| Runtime hardening follow-up (P28) | SinkRegistry hang [x]; inFlight before pool [x]; Python schema `!=` gate [x] | NEXT=`DONE`; phase 28 closed |
| Diagnostic evolution (P29) | multi-host correlation; incident timeline; alert silence; DNS control; TCP connect | queued `P29-001…005`; **NEXT stays DONE** until explicit `P29-001` |
