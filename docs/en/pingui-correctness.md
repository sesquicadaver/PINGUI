...
> **Archival:** phase 33 **closed** (P33-001…008). Phase 34 also **closed** — [pingui-route-persistence.md](pingui-route-persistence.md). Authoritative ROADMAP **NEXT=P36-012** — [pingui-geoip.md](pingui-geoip.md). Stabilization: [pingui-stabilization.md](pingui-stabilization.md).
...
* ROADMAP **NEXT=P36-012**; all P33-001…008 `[x]`; phase index ✅ DONE;
