...
> **Archival:** phase 33 **closed** (P33-001…008). Phase 34 also **closed** — [pingui-route-persistence.md](pingui-route-persistence.md). Authoritative ROADMAP **NEXT=P35-005** — [pingui-unattended.md](pingui-unattended.md). Stabilization: [pingui-stabilization.md](pingui-stabilization.md).
