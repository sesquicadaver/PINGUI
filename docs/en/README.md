...
On **`main`** and **`beta`** — full package (Java Pro + Python) after merge; **`beta`** is the development branch, **`main`** is the last stable snapshot. Linear ROADMAP queue: **NEXT = P32-008** (phase 32 — [ROADMAP.md § NEXT](ROADMAP.md#next--single-source-of-truth)). Branches: [README.en.md](../README.en.md).
...
| [ROADMAP.md](ROADMAP.md) | Developer | Official plan: phases 0–32; NEXT=P32-008 |
