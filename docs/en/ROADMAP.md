...
| Field | Value |
|------|----------|
| **Current task** | **P22-004** |
| **Phase** | 22 — Host problem UX |
| **DoD (short)** | UI: host problem icon + detail dialog |
| **Branch** | `beta` |
...
**Queue status:** open — **NEXT = P22-004** (phase 22 — host problem UX).
...
**Backlog (historical sprint line):** M/B roadmap closed; **IPv6 — Phase 9**; **Python NOC — Phase PY**; **Pro — Phases 10–19**; **Phase 20 GUI UX**. Linear queue — **NEXT=P22-004**.
