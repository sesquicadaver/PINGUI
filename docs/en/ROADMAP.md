...
|------|----------|
| **Current task** | **DONE** |
| **Phase** | 36 — GeoIP / IP metadata (offline enrichment) — **closed** |
| **DoD (short)** | Phase 36 queue exhausted; wait for an explicit new ID |
| **Branch** | `beta` |
...
**Queue status:** **NEXT = DONE** (phase 36 closed; [pingui-geoip.md](pingui-geoip.md)).
...
**Queue:** after P35; **NEXT = DONE** (phase 36 closed).
...
| **P36-012** | [x] Legacy/docs close | `MergingIpMetadataProvider`, docs | removed GeoCountry/AsnLookup/AsnInfo; Python not expanded; NEXT=`DONE` |
