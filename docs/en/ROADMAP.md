...
| Field | Value |
|------|----------|
| **Current task** | **P20-008** |
| **Phase** | 20 — GUI UX |
| **DoD (short)** | Self-check ProgressBar |
| **Branch** | `beta` |
...
**Queue status:** open — **NEXT = P20-008** (phase 20 — GUI UX: quick UX → polish → feature depth).
...
**Backlog (historical sprint line):** M/B roadmap closed; **IPv6 — Phase 9**; **Python NOC — Phase PY**; **Pro — Phases 10–19**; **Phase 20 GUI UX**. Linear queue — **NEXT=P20-008**.
