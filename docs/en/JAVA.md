...
The linear ROADMAP queue: **NEXT = P29-001** (phase 28 — runtime hardening). Details — [docs/en/ROADMAP.md](ROADMAP.md) § NEXT. Hardening post-audit (P26): [ADR_HARDENING.md](ADR_HARDENING.md).
