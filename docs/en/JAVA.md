...
The linear ROADMAP queue: **NEXT = P32-007** (phase 32 — Stabilization). Details — [docs/en/ROADMAP.md](ROADMAP.md) § NEXT; [pingui-stabilization.md](pingui-stabilization.md). Hardening post-audit (P26): [ADR_HARDENING.md](ADR_HARDENING.md).
