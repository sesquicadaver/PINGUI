...
The linear ROADMAP queue: **NEXT = P36-008** (phase 36 — GeoIP / IP metadata). Details — [docs/en/ROADMAP.md](ROADMAP.md) § NEXT; [pingui-geoip.md](pingui-geoip.md). Archival P34: [pingui-route-persistence.md](pingui-route-persistence.md). Hardening post-audit (P26): [ADR_HARDENING.md](ADR_HARDENING.md).
