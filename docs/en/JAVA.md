...
The linear ROADMAP queue: **NEXT = P29-003** (phase 29 — diagnostic evolution). Details — [docs/en/ROADMAP.md](ROADMAP.md) § NEXT. Hardening post-audit (P26): [ADR_HARDENING.md](ADR_HARDENING.md).
