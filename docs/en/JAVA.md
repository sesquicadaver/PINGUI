...
The linear ROADMAP queue: **NEXT = P34-001** (phase 34 — Correctness follow-up). Details — [docs/en/ROADMAP.md](ROADMAP.md) § NEXT; [pingui-route-persistence.md](pingui-route-persistence.md). Hardening post-audit (P26): [ADR_HARDENING.md](ADR_HARDENING.md).
