...
The linear ROADMAP queue: **NEXT = DONE** (phase 31 — GUI information hierarchy). Details — [docs/en/ROADMAP.md](ROADMAP.md) § NEXT; evo: [pingui-evo-gui.md](pingui-evo-gui.md). Hardening post-audit (P26): [ADR_HARDENING.md](ADR_HARDENING.md).
