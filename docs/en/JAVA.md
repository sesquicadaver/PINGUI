...
The linear ROADMAP queue: **NEXT = DONE** (phase 30 closed). Details — [docs/en/ROADMAP.md](ROADMAP.md) § NEXT. Hardening post-audit (P26): [ADR_HARDENING.md](ADR_HARDENING.md).
