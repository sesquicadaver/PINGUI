...
The linear ROADMAP queue: **NEXT = P33-004** (phase 33 — Correctness). Details — [docs/en/ROADMAP.md](ROADMAP.md) § NEXT; [pingui-correctness.md](pingui-correctness.md). Hardening post-audit (P26): [ADR_HARDENING.md](ADR_HARDENING.md).
