...
> **Архів:** фаза 35 **closed** (P35-001…010). Актуальний ROADMAP **NEXT=P36-011** — [pingui-geoip.md](pingui-geoip.md).
...
| **P35-003** | P0 | Loss window semantics | [x] Sliding attempt window (≤50); loss=NULL при <2 probes |
