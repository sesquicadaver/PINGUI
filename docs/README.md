...
На **`main`** і **`beta`** — повний пакет (Java Pro + Python) після merge; **`beta`** — гілка розробки, **`main`** — останній стабільний зріз. Лінійна черга ROADMAP: **NEXT = P20-001** (фаза 20 — [ROADMAP.md § NEXT](ROADMAP.md#next--єдине-джерело-правди)). «Гілки» — [README.md](../README.md).
...
| [ROADMAP.md](ROADMAP.md) | Розробник | Офіційний план: фази 0–20 (Pro/NOC + telemetry + hardening + GUI UX); NEXT=P20-001 |
