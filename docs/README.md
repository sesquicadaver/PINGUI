...
На **`main`** і **`beta`** — повний пакет (Java Pro + Python) після merge; **`beta`** — гілка розробки, **`main`** — останній стабільний зріз. Лінійна черга ROADMAP: **NEXT = P19-006** (фаза 19 — [ROADMAP.md § NEXT](ROADMAP.md#next--єдине-джерело-правди)). «Гілки» — [README.md](../README.md).
...
| [ROADMAP.md](ROADMAP.md) | Розробник | Офіційний план: фази 0–19 (Pro/NOC + telemetry + hardening); NEXT=P19-006 |
