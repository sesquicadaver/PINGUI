...
На **`main`** і **`beta`** — повний пакет (Java Pro + Python) після merge; **`beta`** — гілка розробки, **`main`** — останній стабільний зріз. Лінійна черга ROADMAP: **NEXT = P34-005** (фаза 34 — [ROADMAP.md § NEXT](ROADMAP.md#next--єдине-джерело-правди)). «Гілки» — [README.md](../README.md).
...
| [ROADMAP.md](ROADMAP.md) | Розробник | Офіційний план: фази 0–34; NEXT=P34-005 |
...
| [pingui-route-persistence.md](pingui-route-persistence.md) | Розробник | Correctness follow-up → фаза 34 |
