...
На **`main`** і **`beta`** — повний пакет (Java Pro + Python) після merge; **`beta`** — гілка розробки, **`main`** — останній стабільний зріз. Лінійна черга ROADMAP: **NEXT = P33-003** (фаза 33 — [ROADMAP.md § NEXT](ROADMAP.md#next--єдине-джерело-правди)). «Гілки» — [README.md](../README.md).
...
| [ROADMAP.md](ROADMAP.md) | Розробник | Офіційний план: фази 0–33; NEXT=P33-003 |
