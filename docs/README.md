...
На **`main`** і **`beta`** — повний пакет (Java Pro + Python) після merge; **`beta`** — гілка розробки, **`main`** — останній стабільний зріз. Лінійна черга ROADMAP: **NEXT = P29-004** (фаза 29 — [ROADMAP.md § NEXT](ROADMAP.md#next--єдине-джерело-правди)). «Гілки» — [README.md](../README.md).
...
| [ROADMAP.md](ROADMAP.md) | Розробник | Офіційний план: фази 0–29; NEXT=P29-004 |
