...
Лінійна черга ROADMAP: **NEXT = P31-004** (фаза 31 — GUI information hierarchy). Деталі — [docs/ROADMAP.md](ROADMAP.md) § NEXT; evo: [pingui-evo-gui.md](pingui-evo-gui.md). Hardening post-audit (P26): [ADR_HARDENING.md](ADR_HARDENING.md).
