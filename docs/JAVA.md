...
Лінійна черга ROADMAP: **NEXT = P29-004** (фаза 29 — diagnostic evolution). Деталі — [docs/ROADMAP.md](ROADMAP.md) § NEXT. Hardening post-audit (P26): [ADR_HARDENING.md](ADR_HARDENING.md).
