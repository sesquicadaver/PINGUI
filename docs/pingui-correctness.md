...
> **Архів:** фаза 33 **closed** (P33-001…008). Фаза 34 також **closed** — [pingui-route-persistence.md](pingui-route-persistence.md). ROADMAP **NEXT=DONE**. Stabilization: [pingui-stabilization.md](pingui-stabilization.md).
