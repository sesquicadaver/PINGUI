...
> **Архів:** фаза 33 **closed** (P33-001…008). Фаза 34 також **closed** — [pingui-route-persistence.md](pingui-route-persistence.md). Актуальний ROADMAP **NEXT=P36-008** — [pingui-geoip.md](pingui-geoip.md). Stabilization: [pingui-stabilization.md](pingui-stabilization.md).
...
* ROADMAP **NEXT=P36-008**; усі P33-001…008 `[x]`; індекс фаз ✅ DONE;
