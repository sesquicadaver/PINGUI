...
> **Архів:** фаза 33 **closed** (P33-001…008). Фаза 34 також **closed** — [pingui-route-persistence.md](pingui-route-persistence.md). Актуальний ROADMAP **NEXT=P35-006** — [pingui-unattended.md](pingui-unattended.md). Stabilization: [pingui-stabilization.md](pingui-stabilization.md).
