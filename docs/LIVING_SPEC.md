...
| GUI information hierarchy (P31) | a11y [x]; post-P31 UX: no Monitoring/log spam, compact inspector, history iff DB | [pingui-evo-gui.md](pingui-evo-gui.md); P31-007 [x]; фаза закрита; `HistoryPanelTest`, `UiFeedbackRouterTest` |
