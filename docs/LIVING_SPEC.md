...
| Hardening queue (P26) | ROADMAP фаза 26: telemetry isolation, SQLite reopen, launchers, MainController/MonitorService split, JaCoCo packages, latency EWMA | NEXT=`P26-001`; DoD у `docs/ROADMAP.md` § Фаза 26 |
