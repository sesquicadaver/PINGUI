...
| Diagnostic evolution (P29) | multi-host correlation; incident timeline; alert silence; DNS control; TCP connect | queued `P29-001…005`; **NEXT лишається DONE** до явного `P29-001` |
