...
Python `beta` містить референсну реалізацію (`alert_dispatcher.py`, `alert_rate_limiter.py`, `desktop_notifier.py`). Java `main`/`beta` — ще без alert pipeline (фаза 10, P10-010…P10-050).
