...
CLI overrides — P16-041 (`--telemetry-syslog HOST:PORT`, `--telemetry-jsonl DIR`; not the same as `--telemetry-jsonl-dir` for retention). Wire sinks у daemon — після P16-041+.
